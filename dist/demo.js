(function (riot) {
  ...
  riot.tag2('highlight', '<yield></yield>', 'highlight,[riot-tag="highlight"] { display: block; font-family: monospace; border: 1px solid #ddd; border-radius: .25em; padding: 1em !important; }', '', function (opts) {
