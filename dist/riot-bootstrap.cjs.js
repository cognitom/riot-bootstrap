...
riot.tag2('inp-group-addon', '<yield></yield>', 'inp-group-addon,[riot-tag="inp-group-addon"],[data-is="inp-group-addon"]{ position: relative; display: inline-block; padding: 6px 12px; font-size: 14px; font-weight: 400; line-height: 1.42857143; color: #555; text-align: center; background-color: #eee; border: 1px solid #ccc; }', '', function (opts) {
    this.mixin(parentScope);
});
